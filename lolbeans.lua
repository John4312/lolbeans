...
mobkill:CreateToggle("Train King Beetle", nil, function(State) if State then api.humanoidrootpart().CFrame = CFrame.new(142.13784790039062, 4.547219753265381, 165.29922485351562) wait(3) api.humanoidrootpart() = CFrame.new(111.35742950439453, 10.547220230102539, 250.4386444091797) end end)
